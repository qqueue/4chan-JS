...
var Parser = {
  ...
  PostMenu = {
    ...
    open: function(a) {
      ...
      if (file = $.id("fT" + d))
        if (b = $.cls("fileThumb",
          file.parentNode)[0]) b = /\.(png|jpg)$/.test(b.href) ? b.href : "http://0.t.4cdn.org/" + Main.board + "/" + b.href.match(/\/([0-9]+)\..+$/)[1] + "s.jpg", c += '<li><ul><li><a href="//www.google.com/searchbyimage?image_url=' + b + '" target="_blank">Google</a></li><li><a href="http://iqdb.org/?url=' + b + '" target="_blank">iqdb</a></li></ul>Image search &raquo</li>';
  ...
  QuoteInline = {
    ...
    toggle: function(a, b) {
      var c, d, e;
      (c = a.getAttribute("href").match(/^(?:\/([^\/]+)\/)?(?:thread\/)?([0-9]+)?#p([0-9]+)$/)) &&
        "rs" != c[1] && !QuoteInline.isSelfQuote(a, c[3], c[1]) && (b && b.preventDefault(), (d = a.getAttribute("data-pfx")) ? (a.removeAttribute("data-pfx"), $.removeClass(a, "linkfade"), d = $.id(d + "p" + c[3]), d.parentNode.removeChild(d), "backlink" == a.parentNode.parentNode.className && (d = $.id("pc" + c[3]), c = +d.getAttribute("data-inline-count") - 1, 0 == c ? (d.style.display = "", d.removeAttribute("data-inline-count")) : d.setAttribute("data-inline-count", c))) : (e = $.id("p" + c[3])) ? QuoteInline.inline(a, e, c[3]) : QuoteInline.inlineRemote(a, c[1] ||
          Main.board, c[2], c[3]))
    },
    inlineRemote: function(a, b, c, d) {
      ...
      a.hasAttribute("data-loading") || (h = b + "-" + c, (e = $.cache[h]) && (f = Parser.buildPost(e, b, d)) ? (Parser.parsePost(f), QuoteInline.inline(a, f)) : (g = a.nextElementSibling) && $.hasClass(g, "spinner") ? g.parentNode.removeChild(g) : (g = document.createElement("div"), g.className = "preview spinner inlined", g.textContent = "Loading...", a.parentNode.insertBefore(g, a.nextSibling), e = function() {
        ...
        if (200 == this.status || 304 == this.status ||
          0 == this.status) c = Parser.parseThreadJSON(this.responseText), $.cache[h] = c, (c = Parser.buildPost(c, b, d)) ? (g.parentNode && g.parentNode.removeChild(g), Parser.parsePost(c), QuoteInline.inline(a, c)) : ($.addClass(a, "deadlink"), g.textContent = "This post doesn't exist anymore");
        ...
        "1"), $.get("//a.4cdn.org/" + b + "/thread/" + c + ".json", {
        onload: e,
        onerror: f
      })))
    },
    inline: function(a, b, c) {
      ...
      g ? (a = h.parentNode.parentNode.getAttribute("data-pfx") || "", a = $.id(a + "m" + h.id.split("_")[1]), a.insertBefore(f, a.firstChild), (f = b.parentNode.getAttribute("data-inline-count")) ? f = +f + 1 : (f = 1, b.parentNode.style.display = "none"), b.parentNode.setAttribute("data-inline-count",
        f)) : ($.hasClass(a.parentNode, "quote") && (a = a.parentNode), b = a.parentNode, b.insertBefore(f, a.nextSibling))
    }
  },
  QuotePreview = {
    init: function() {
    ...
    resolve: function(a) {
      ...
      b = QuotePreview;
      b.out = !1;
      if (c = a.getAttribute("href").match(b.regex))(d = a.getAttribute("data-pfx") || "", d = document.getElementById(d + "p" + c[3])) ? (c = d.getBoundingClientRect(), 0 < c.top && c.bottom < document.documentElement.clientHeight &&
        !$.hasClass(d.parentNode, "post-hidden")) ? $.hasClass(d, "highlight") || location.hash.slice(1) == d.id ? $.hasClass(d, "op") || (b.highlightAnti = d, $.addClass(d, "highlight-anti")) : (b.highlight = d, $.addClass(d, "highlight")) : b.show(a, d) : UA.hasCORS && b.showRemote(a, c[1] || Main.board, c[2], c[3])
    },
    ...
    show: function(a, b, c) {
      var d, e, f;
      c ? (Parser.parsePost(b), b.style.display = "") : (b = b.cloneNode(!0),
        location.hash && location.hash == "#" + b.id && (b.className += " highlight"), b.id = "quote-preview", b.className += " preview" + ($.hasClass(a.parentNode.parentNode, "backlink") ? "" : " reveal-spoilers"), Config.imageExpansion && (f = $.cls("expanded-thumb", b)[0]) && ImageExpansion.contract(f));
  ...
  ImageExpansion = {
    ...
    onLoadStart: function(a, b) {
      ...
      !Main.tid &&
        Config.threadHiding && $.addClass(b.parentNode, "image-expanded-anti");
      a.style.display = "";
      b.style.display = "none";
  ...
  ImageHover = {
    show: function(a) {
      var b, c;
      c = a.parentNode.getAttribute("href");
      (b = c.match(/\.(?:webm|pdf)$/)) ? ".webm" == b[0] && ImageHover.showWebm(a) : (b = document.createElement("img"), b.id = "image-hover", b.alt = "Image", b.onerror = ImageHover.onLoadError,
        b.setAttribute("src", c), document.body.appendChild(b), UA.hasCORS ? (b.style.display = "none", this.timeout = ImageHover.checkLoadStart(b, a)) : b.style.left = a.getBoundingClientRect().right + 10 + "px")
    },
    hide: function() {
      var a;
      clearTimeout(this.timeout);
  ...
  QR = {
    init: function() {
      ...
      if (UA.hasFormData) {
        ...
        this.cooldowns = {};
        for (a in window.cooldowns) this.cooldowns[a] =
          1E3 * window.cooldowns[a];
    ...
    show: function(a) {
      ...
      if (QR.currentTid) Main.tid || QR.currentTid == a || ($.id("qrTid").textContent = $.id("qrResto").value =
        QR.currentTid = a, $.byName("com")[1].value = "", QR.startCooldown()), Main.hasMobileLayout && ($.id("quickReply").style.top = window.pageYOffset + 25 + "px");
      else {
        QR.currentTid = a;
        e = $.id("postForm");
        ...
        d.innerHTML = '<div id="qrHeader" class="drag postblock">Reply to Thread No.<span id="qrTid">' +
          a + '</span><img alt="X" src="' + Main.icons.cross + '" id="qrClose" class="extButton" title="Close Window"></div>';
        ...
        for (c = h.length - 1; b < c; ++b) {
          ...
          else if ("File" == m) k = h[b].children[1].firstChild.cloneNode(!1), k.tabIndex = "", k.id = "qrFile", k.size = "19", k.addEventListener("change", QR.onFileChange, !1), g.appendChild(k), UA.hasDragAndDrop && ($.addClass(k, "qrRealFile"), k = document.createElement("div"), k.id = "qrDummyFile", l = document.createElement("button"),
            l.id = "qrDummyFileButton", l.type = "button", l.textContent = "Browse\u2026", k.appendChild(l), l = document.createElement("span"), l.id = "qrDummyFileLabel", l.textContent = "No file selected.", k.appendChild(l), g.appendChild(k)), k.title = "Shift + Click to remove the file";
        ...
        e.querySelector('.desktop > label > input[name="spoiler"]') && (e = document.createElement("span"), e.id = "qrSpoiler", e.innerHTML = '<label>[<input type="checkbox" value="on" name="spoiler">Spoiler?]</label>',
    ...
    onFileChange: function(a) {
      var b;
      this.value ? (b = window.maxFilesize, this.files ? (a = this.files[0].size, "video/webm" == this.files[0].type &&
        window.maxWebmFilesize && (b = window.maxWebmFilesize)) : a = 0, QR.fileDisabled ? QR.showPostError("Image limit reached.", "imagelimit", !0) : a > b ? QR.showPostError("Error: Maximum file size allowed is " + Math.floor(b / 1048576) + " MB", "filesize", !0) : QR.hidePostError()) : QR.hidePostError();
      QR.startCooldown()
    },
    onKeyDown: function(a) {
      if (a.ctrlKey && 83 == a.keyCode) {
        ...
        b = a.selectionStart;
        c = a.selectionEnd;
        a.value ? (d = "[spoiler]" + a.value.slice(b, c) + "[/spoiler]", a.value =
          a.value.slice(0, b) + d + a.value.slice(c), a.setSelectionRange(c + 19, c + 19)) : (a.value = "[spoiler][/spoiler]", a.setSelectionRange(9, 9))
    ...
    submit: function(a) {
      ...
      QR.presubmitChecks(a) && (QR.auto = !1, QR.xhr = new XMLHttpRequest, QR.xhr.open("POST", document.forms.qrPost.action, !0), QR.xhr.withCredentials = !0, QR.xhr.upload.onprogress = function(a) {
        QR.btn.value =
          a.loaded >= a.total ? "100%" : (0 | a.loaded / a.total * 100) + "%"
    ...
    getCooldown: function(a) {
      return QR.currentTid !=
        QR.lastTid ? QR.cooldowns[a] : QR.cooldowns[a + "_intra"]
    },
    ...
    startCooldown: function() {
      var a, b;
      QR.noCooldown || !$.id("quickReply") || QR.xhr || (clearInterval(QR.pulse), a = (b = $.id("qrFile")) && b.value ? "image" : "reply", (b = QR.getPostTime(a)) ? (QR.timestamp = parseInt(b, 10), QR.activeDelay =
        QR.getCooldown(a), QR.cdElapsed = Date.now() - QR.timestamp, QR.cooldown = Math.floor((QR.activeDelay - QR.cdElapsed) / 1E3), 0 >= QR.cooldown || 0 > QR.cdElapsed ? (QR.cooldown = !1, QR.removePostTime(a)) : (QR.btn.value = QR.cooldown + "s", QR.pulse = setInterval(QR.onPulse, 1E3))) : QR.btn.value = "Post")
    },
    onPulse: function() {
  ...
  ThreadHiding = {
    ...
    hide: function(a) {
      var b, c;
      c = $.id("t" + a);
      Main.hasMobileLayout ? (c.style.display = "none", $.addClass(c.nextElementSibling,
  ...
  ReplyHiding = {
    ...
    toggleRFunc: function(a, b) {
      ...
      for (c = 1; h[c] !== d; ++c);
      for (; f = h[c]; ++c)
        if (!f.parentNode.hasAttribute("data-pfx") &&
          (g = f.querySelectorAll("#" + f.id + " > .quotelink"), g[0])) {
  ...
  ThreadWatcher = {
    init: function() {
      ...
      Main.hasMobileLayout ?
        a.style.display = "none" : (Config["TW-position"] ? a.style.cssText = Config["TW-position"] : (a.style.left = "10px", a.style.top = "380px"), a.style.position = Config.fixedThreadWatcher ? "fixed" : "");
    ...
    toggleList: function(a) {
      ...
      a && a.preventDefault();
      !Main.tid && ThreadWatcher.canAutoRefresh() &&
    ...
    toggle: function(a, b) {
      var c, d, e;
      c = a + "-" + (b || Main.board);
      this.watched[c] ? (this.blacklisted[c] = 1, delete this.watched[c]) :
        (d = $.cls("subject", $.id("pi" + a))[0].textContent, e = $.id("m" + a).innerHTML, d = ThreadWatcher.generateLabel(d, e, a), e = (thread = $.id("t" + a)).children[1] ? thread.lastElementChild.id.slice(2) : a, this.watched[c] = [d, e, 0]);
      this.save();
      this.load();
      this.build(!0)
    },
    ...
    setRefreshTimestamp: function() {
      localStorage.setItem("4chan-tw-timestamp",
        Date.now())
    },
    ...
    onCatalogsLoaded: function(a) {
      ...
      for (d in a)
        for (e = a[d], b = 0; c = e[b]; ++b)
          for (f = c.threads, c = 0; h = f[c]; ++c) g = h.no + "-" + d, this.blacklisted[g] ? k[g] = 1 : Filter.match(h,
            d) && this.addRaw(h, d);
      this.blacklisted = k;
      this.build(!0);
      this.refresh()
    ...
    refreshCurrent: function(a) {
      var b, c, d;
      b = Main.tid + "-" + Main.board;
      this.watched[b] && (d = (c = $.id("t" + Main.tid)).children[1] ? c.lastElementChild.id.slice(2) : Main.tid,
        this.watched[b][1] < d && (this.watched[b][1] = d), this.watched[b][2] = 0, this.save(), a && this.build())
    },
    ...
    fetch: function(a, b) {
      ...
      if (-1 == ThreadWatcher.watched[a][1]) {
        ...
        a.split("-"), d = new XMLHttpRequest, d.onload = function() {
          var c, d, h, g;
          if (200 == this.status) {
  ...
  ThreadExpansion = {
      ...
      if (b = a.getAttribute("href").match(/^(?:thread\/)([0-9]+)#p([0-9]+)$/)) c = b[1], d = b[2], e = a.parentNode, e.textContent = "Loading...", $.get("//a.4cdn.org/" + Main.board + "/thread/" + c + ".json", {
        onload: function() {
          ...
          if (200 == this.status) {
            ...
            g ? (g = Parser.buildHTMLFromJSON(g, Main.board),
              b.innerHTML = $.cls("postMessage", g)[0].innerHTML, Parser.prettify && Parser.parseMarkup(b), window.jsMath && Parser.parseMathOne(b)) : e.textContent = "This post doesn't exist anymore."
    ...
    toggle: function(a) {
      ...
      $.hasClass(b, "tExpanded") ? (b.className = b.className.replace(" tExpanded", " tCollapsed"), e.children[0].src = Main.icons.plus, e.children[1].style.display = "inline", e.children[2].style.display = "none", c && (a = c.innerHTML, c.innerHTML = d.textContent, d.textContent = a)) : $.hasClass(b, "tCollapsed") ? (b.className = b.className.replace(" tCollapsed", " tExpanded"), e.children[0].src = Main.icons.minus, e.children[1].style.display = "none", e.children[2].style.display =
        "inline", c && (a = c.innerHTML, c.innerHTML = d.textContent, d.textContent = a)) : (e.children[0].src = Main.icons.rotate, ThreadExpansion.fetch(a))
    },
    fetch: function(a) {
      $.get("//a.4cdn.org/" + Main.board + "/thread/" + a + ".json", {
        onload: function() {
          ...
          if (200 == this.status) {
            ...
            f = $.id("m" + a);
            (g = $.cls("abbr", f)[0]) && /^Comment/.test(g.textContent) && (e.setAttribute("data-truncated", "1"), g = document.createElement("div"), g.style.display = "none", g.textContent = f.innerHTML, f.parentNode.insertBefore(g, f.nextSibling), (g = $.cls("capcodeReplies",
              f)[0]) ? (f.innerHTML = h[0].com + "<br><br>", f.appendChild(g)) : f.innerHTML = h[0].com, Parser.prettify && Parser.parseMarkup(f), window.jsMath && Parser.parseMathOne(f));
          ...
          } else 404 == this.status ? (k.children[0].src = Main.icons.plus, k.children[0].display = "none", k.children[1].textContent = "This thread doesn't exist anymore.") : (k.children[0].src =
            Main.icons.plus, console.log("ThreadExpansion: " + this.status + " " + this.statusText))
        },
        onerror: function() {
  ...
  ThreadUpdater = {
    ...
    buildDesktopControl: function(a) {
      ...
      b.appendChild(d);
      b.appendChild(document.createTextNode("] "));
      Config.updaterSound && (b.appendChild(document.createTextNode(" [")), d = document.createElement("label"),
        c = document.createElement("input"), c.type = "checkbox", c.title = "Play a sound on new replies to your posts", c.setAttribute("data-cmd", "sound"), this["soundNode" + a] = c, d.appendChild(c), d.appendChild(document.createTextNode("Sound")), b.appendChild(d), b.appendChild(document.createTextNode("] ")));
      b.appendChild(this["statusNode" + a] = document.createElement("span"));
      (a = a ? $.cls("navLinks" + a)[0] : $.cls("navLinks")[1]) && a.appendChild(b)
    },
    initControls: function() {
      Main.hasMobileLayout ? (this.buildMobileControl($.id("refresh_top")),
        this.buildMobileControl($.id("refresh_bottom"), !0)) : (this.buildDesktopControl(), this.buildDesktopControl(!0))
    },
    start: function() {
    ...
    adjustDelay: function(a) {
      0 == a ? this.force || this.delayId < this.delayRange.length - 1 && ++this.delayId : this.delayId =
        document[this.hidden] ? this.delayIdHidden : 0;
    ...
    onScroll: function(a) {
      ThreadUpdater.hadAuto && document.documentElement.scrollHeight <= window.innerHeight + window.pageYOffset && !document[ThreadUpdater.hidden] &&
    ...
    markDeletedReplies: function(a) {
      ...
      for (b =
        0; c = a[b]; ++b) d[c.id] || $.hasClass(c, "deleted") || (this.deletionQueue[c.id] ? (e = document.createElement("img"), e.src = Main.icons2.trash, e.className = "trashIcon", e.title = "This post has been deleted", $.addClass(c, "deleted"), $.cls("postNum", c)[1].appendChild(e), delete this.deletionQueue[c.id]) : this.deletionQueue[c.id] = 1)
    },
    onload: function() {
      var a, b, c, d, e, f, h, g, k, l, n, m;
      c = ThreadUpdater;
      ...
      if (200 == this.status) {
        ...
        b = !!f[0].imagelimit;
        QR.enabled && b != QR.fileDisabled && (QR.fileDisabled =
          b);
        ...
        if (b) {
          ...
          m || (!c.force && l.scrollHeight > window.innerHeight ? (c.lastReply || k == Main.tid || ((c.lastReply = g.lastChild).className += " newPostsMarker"), Parser.hasYouMarkers ? (c.setIcon("rep"), c.audioEnabled && document[c.hidden] && c.audio.play()) : Parser.hasHighlightedPosts && "rep" !== c.currentIcon ? c.setIcon("hl") : 0 == c.unreadCount && c.setIcon("new"),
            c.unreadCount += b, document.title = "(" + c.unreadCount + ") " + c.pageTitle) : c.setStatus(b + " new post" + (1 < b ? "s" : "")));
        ...
        f[0].archived && (c.setError("This thread is archived"), c.dead ||
          (c.setIcon("dead"), window.thread_archived = !0, c.dead = !0, c.stop()))
  ...
  ThreadStats = {
    init: function() {
      ...
      Main.hasMobileLayout ? (this.nodeBot = {}, a = $.cls("navLinks"), a[0] && (a = a[a.length - 1].nextElementSibling, a.parentNode.insertBefore(this.nodeTop, a))) : (this.nodeBot = this.nodeTop.cloneNode(!1), a = $.cls("navLinks"), a[1] &&
        a[1].appendChild(this.nodeTop), a[2] && a[2].appendChild(this.nodeBot));
  ...
  Filter = {
    ...
    exec: function(a, b, c, d) {
      ...
      } else if (6 == m.type && (void 0 === n && (n = (n = b.parentNode.getElementsByClassName("fileText")[0]) ?
        n.firstElementChild.textContent : ""), m.pattern.test(n))) {
        p = !0;
        break
      }
      if (p) {
...
var SettingsMenu = {
  ...
  save: function() {
    ...
    for (a = 0; c = b[a]; ++a) d = c.getAttribute("data-option"),
      Config[d] = "checkbox" == c.type ? c.checked : c.value;
    Config.save(e);
    SettingsMenu.close();
...
var Main = {
  ...
  onclick: function(a) {
    ...
    if ((b = a.target) != document)
      ...
      } else Config.disableAll || (QR.enabled && "Reply to this post" == b.title ? (a.preventDefault(), c = Main.tid || b.previousElementSibling.getAttribute("href").split("#")[0].split("/")[1],
          QR.quotePost(c, !a.ctrlKey && b.textContent)) : Config.imageExpansion && 1 == a.which && b.parentNode && $.hasClass(b.parentNode, "fileThumb") && "A" == b.parentNode.nodeName && !$.hasClass(b.parentNode, "deleted") && !$.hasClass(b, "mFileInfo") ? ImageExpansion.toggle(b) && a.preventDefault() : Config.inlineQuotes && 1 == a.which && $.hasClass(b, "quotelink") ? a.shiftKey ? (a.preventDefault(), window.location = b.href) : QuoteInline.toggle(b, a) : Config.threadExpansion && b.parentNode && $.hasClass(b.parentNode, "abbr") ? (a.preventDefault(), ThreadExpansion.expandComment(b)) :
        Main.isMobileDevice && Config.quotePreview && $.hasClass(b, "quotelink") && b.getAttribute("href").match(QuotePreview.regex) ? a.preventDefault() : $.hasClass(b, "mFileInfo") && (a.preventDefault(), a.stopPropagation()))
  },
  onThreadMouseOver: function(a) {
    ...
    if (Config.quotePreview && $.hasClass(b, "quotelink") && !$.hasClass(b, "deadlink") && !$.hasClass(b, "linkfade")) QuotePreview.resolve(a.target);
      ...
      "dateTime")) Parser.onDateMouseOver(b);
