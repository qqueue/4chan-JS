...
var Parser = {
  ...
  parseBacklinks: function(a, b) {
    ...
    if (e = document.getElementById("m" + a).getElementsByClassName("quotelink"))
      for (f = {}, c = 0; d = e[c]; ++c)
        if (g = d.getAttribute("href").split("#p"), g[1])(g[1] == b && (d.textContent += " (OP)"), h = document.getElementById("pi" + g[1])) ? f[g[1]] || (f[g[1]] = !0, d = document.createElement("span"), d.innerHTML = Main.hasMobileLayout ? '<a href="#p' + a + '" class="quotelink">&gt;&gt;' + a + '</a><a href="#p' + a + '" class="quoteLink"> #</a> ' : '<a href="#p' + a + '" class="quotelink">&gt;&gt;' + a + "</a> ", (k = document.getElementById("bl_" + g[1])) || (k = document.createElement("div"), k.id = "bl_" + g[1], k.className = "backlink", Main.hasMobileLayout && (k.className = "backlink mobile", h = document.getElementById("p" + g[1])), h.appendChild(k)), k.appendChild(d)) : Main.tid && "/" != g[0].charAt(0) && (d.textContent += " \u2192")
  },
