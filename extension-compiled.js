...
var Parser = {
    ...
    buildHTMLFromJSON: function(a, b, c, d) {
      ...
      Main.tid && b == Main.board ? (y = "#p" + a.no, z = "javascript:quote('" + a.no + "')") : (y = "thread/" + c + "#p" + a.no, z = "thread/" + c + "#q" + a.no);
      ...
      x = a.country ? "pol" == b ? ' <img src="//s.4cdn.org/image/country/troll/' + a.country.toLowerCase() + '.gif" alt="' + a.country + '" title="' + a.country_name + '" class="countryFlag">' : ' <span title="' + a.country_name + '" class="flag flag-' + a.country.toLowerCase() + '"></span>' : "";
      a.filedeleted ? g = '<div id="f' + a.no + '" class="file"><span class="fileThumb"><img src="' + Parser.icons.del + '" class="fileDeletedRes" alt="File deleted."></span></div>' : a.ext && (g = Parser.decodeSpecialChars(a.filename), p = w = a.filename + a.ext, g.length > (f ? 40 : 30) && (p = Parser.encodeSpecialChars(g.slice(0, f ? 35 : 25)) + "(...)" + a.ext, J = !0), a.tn_w || a.tn_h || ".gif" != a.ext || (a.tn_w = a.w, a.tn_h = a.h), u = 1048576 <= a.fsize ? (0 | a.fsize / 1048576 * 100 + 0.5) / 100 + " M" : 1024 < a.fsize ? (0 | a.fsize / 1024 + 0.5) + " K" : a.fsize + " ", a.spoiler && !Config.revealSpoilers && (p = "Spoiler Image", l = '" title="' + w + '"', B = " imgspoiler", m = "//s.4cdn.org/image/spoiler" + (Parser.customSpoiler[b] || "") + ".png", a.tn_w = 100, a.tn_h = 100), m || (m = "//t.4cdn.org/" + b + "/" + a.tim + "s.jpg"), g = ".pdf" == a.ext ? "PDF" : a.w + "x" + a.h, "f" != b ? (n = n + "/" + a.tim + a.ext, k = '<a class="fileThumb' + B + '" href="' + n + '" target="_blank"><img src="' + m + '" alt="' + u + 'B" data-md5="' + a.md5 + '" style="height: ' + a.tn_h + "px; width: " + a.tn_w + 'px;"><div class="mFileInfo mobile">' + u + "B " + a.ext.slice(1).toUpperCase() + "</div></a>", l = '<div class="fileText" id="fT' + a.no + l + ">File: <a" + (J ? ' title="' + w + '"' : "") + ' href="' + n + '" target="_blank">' + p + "</a> (" + u + "B, " + g + ")</div>") : (n = n + "/" + a.filename + a.ext, g += ", " + a.tag, l = '<div class="fileText" id="fT' + a.no + '">File: <a href="' +
      ...
      e.id = "pc" + a.no;
      e.innerHTML = (f ? "" : '<div class="sideArrows" id="sa' + a.no + '">&gt;&gt;</div>') + '<div id="p' + a.no + '" class="post ' + A + C + '"><div class="postInfoM mobile" id="pim' + a.no + '"><span class="nameBlock' + s + '"><span class="name">' + k + "</span>" + r + q + t + h + x + '<br><span class="subject">' + m + '</span></span><span class="dateTime postNum" data-utc="' +
        a.time + '">' + a.now + ' <a href="' + a.no + "#p" + a.no + '" title="Link to this post">No.</a><a href="javascript:quote(\'' + a.no + '\');" title="Reply to this post">' + a.no + "</a></span></div>" + (f ? g : "") + '<div class="postInfo desktop" id="pi' + a.no + '"' + (b != Main.board ? ' data-board="' + b + '"' : "") + '><input type="checkbox" name="' + a.no + '" value="delete"> <span class="subject">' + m + '</span> <span class="nameBlock' + s + '">' + D + '<span class="name">' + k + "</span>" + r + q + E + t + h + x + ' </span> <span class="dateTime" data-utc="' + a.time + '">' +
        a.now + '</span> <span class="postNum desktop"><a href="' + y + '" title="Link to this post">No.</a><a href="' + z + '" title="Reply to this post">' + a.no + "</a> " + v + F + "</span></div>" + (f ? "" : g) + '<blockquote class="postMessage" id="m' + a.no + '">' + (a.com || "") + I + H + "</blockquote> </div>" + G;
  ...
  Depager = {
    init: function() {
      ...
      if (a = $.cls("prev")[0])
        ...
        } else a.setAttribute("data-cmd", "depage")
    },
    onScroll: function() {
    ...
    onLoad: function() {
      ...
      if (200 == this.status) {
        ...
        e = 0;
        for (b = 1; c = a[b]; ++b) c.adZone = e, d.push(c), e = e ? 0 : 1;
        Depager.renderNext()
  ...
  QuotePreview = {
    ...
    show: function(a, b, c) {
      var d, e, f;
      c ? (Parser.parsePost(b), b.style.display = "") : (b = b.cloneNode(!0), location.hash && location.hash == "#" + b.id && (b.className += " highlight"), b.id = "quote-preview", b.className += " preview", Config.imageExpansion && (f = $.cls("expanded-thumb", b)[0]) && ImageExpansion.contract(f));
      ...
      f = b.style;
      document.body.appendChild(b);
      Main.isMobileDevice ? (f.top = d.top + a.offsetHeight + window.pageYOffset + "px", e - d.right < (0 | 0.3 * e) ? f.right = e - d.right + "px" : f.left = d.left + "px") : (e - d.right < (0 | 0.3 * e) ? (e -= d.left, f.right = e + 5 + "px") : (e = d.left + d.width, f.left = e + 5 + "px"), a = d.top + a.offsetHeight + window.pageYOffset - b.offsetHeight / 2 - d.height / 2, b = b.getBoundingClientRect().height, d = c.scrollTop != document.body.scrollTop ? c.scrollTop + document.body.scrollTop : document.body.scrollTop, f.top = a < d ? d + "px" : a + b > d + c.clientHeight ? d + c.clientHeight -
        b + "px" : a + "px")
    },
    remove: function(a) {
      var b, c;
  ...
  ImageExpansion = {
    ...
    expandWebm: function(a) {
      ...
      e = document.documentElement.clientWidth - b - 25;
      ...
      b.firstElementChild.addEventListener("click", f.collapseWebm, !1);
      a.appendChild(b);
      return !0
    },
  ...
  QR = {
    ...
    quotePost: function(a, b) {
      !QR.noCooldown && (Main.threadClosed || !Main.tid && Main.isThreadClosed(a)) ? alert("Thread closed. You may not reply at this time.") : (QR.show(a), QR.addQuote(b))
    },
    addQuote: function(a) {
      var b, c, d;
    ...
    show: function(a) {
      ...
      if (QR.currentTid) Main.tid || QR.currentTid == a || ($.id("qrTid").textContent = $.id("qrResto").value = QR.currentTid = a, $.byName("com")[1].value = "", QR.startCooldown()), Main.hasMobileLayout && ($.id("quickReply").style.top = window.pageYOffset + 25 + "px");
        ...
        d.innerHTML = '<div id="qrHeader" class="drag postblock">Reply to Thread No.<span id="qrTid">' + a + '</span><img alt="X" src="' +
    ...
    submit: function(a) {
      a ? QR.submitDirect(!0) : !QR.noCaptcha && window.preupload_captcha && QR.needPreuploadCaptcha ? QR.submitPreupload() : QR.submitDirect()
    },
    ...
    submitPreupload: function() {
      var a, b, c;
      QR.presubmitChecks() && (a = $.id("qrChallenge"), b = $.id("qrCapField"), "" == b.value ? (QR.showPostError("You forgot to type in the CAPTCHA."), b.focus()) : (c = new FormData, c.append("mode", "checkcaptcha"), c.append("challenge", a.value), c.append("response", b.value), QR.xhr = new XMLHttpRequest, QR.xhr.open("POST", document.forms.post.action, !0), QR.xhr.onerror = function() {
        QR.xhr = null;
        QR.submitDirect()
        ...
        b.token ? (a = $.id("qrCapToken"), a.value = b.token, a.removeAttribute("disabled"), QR.submitDirect()) : b.error ? (QR.reloadCaptcha(), QR.btn.value = "Post", QR.showPostError(b.error)) : (b.fail && console.log(b.fail), QR.submitDirect())
      }, a = $.id("qrCapToken"), a.value = "", a.setAttribute("disabled", "1"), QR.btn.value = "Sending", QR.xhr.send(c)))
    },
    submitDirect: function(a) {
      var b;
      QR.hidePostError();
  ...
  ThreadWatcher = {
    init: function() {
      ...
      this.watched = {};
      this.isRefreshing = !1;
      if (location.hash && (a = location.hash.split("lr")[1])) {
        if (a = $.id("pc" + a)) a.nextElementSibling && (a = a.nextElementSibling, (b = $.id("p" + a.id.slice(2))) && $.addClass(b, "highlight")), a = a.getBoundingClientRect(), (0 > a.top || a.bottom > document.documentElement.clientHeight) && window.scrollBy(0, a.top);
      ...
      Config["TW-position"] ? a.style.cssText = Config["TW-position"] : (a.style.left = "10px", a.style.top = "380px");
      a.style.position = Config.fixedThreadWatcher ? "fixed" : "";
      a.innerHTML = '<div class="drag" id="twHeader">Thread Watcher' + (UA.hasCORS ? '<img id="twPrune" class="pointer right" src="' + Main.icons.refresh + '" alt="R" title="Refresh"></div>' : "</div>");
      ...
      window.addEventListener("storage", this.syncStorage, !1);
      !Main.tid && this.canAutoRefresh() && this.refresh()
    },
    syncStorage: function(a) {
      var b;
    ...
    onClick: function(a) {
      a = a.target;
      a.hasAttribute("data-id") ? ThreadWatcher.toggle(a.getAttribute("data-id"), a.getAttribute("data-board")) : a.src && !ThreadWatcher.isRefreshing && ThreadWatcher.refresh()
    },
  ...
  ThreadStats = {
    init: function() {
      ...
      this.pageInterval = setInterval(this.updatePageNumber, 18E4)
    },
    update: function(a, b, c, d) {
      ...
      Main.threadClosed && e.push("Closed");
      ...
      e.push('<span data-tip="Page" class="ts-page">' + (this.pageNumber || "?") + "</span>");
  ...
  Filter = {
    ...
    open: function() {
      ...
      c.innerHTML = '<div class="extPanel reply"><div class="panelHeader">Filters &amp; Highlights<span><img alt="Help" class="pointer" title="Help" data-cmd="filters-help-open" src="' +
        Main.icons.help + '"><img alt="Close" title="Close" class="pointer" data-cmd="filters-close" src="' + Main.icons.cross + '"></span></div><table><thead><tr><th>Order</th><th>On</th><th>Pattern</th><th>Type</th><th>Color</th><th>Hide</th><th>Del</th></tr></thead><tbody id="filter-list"></tbody><tfoot><tr><td colspan="7"><button data-cmd="filters-add">Add</button><button class="right" data-cmd="filters-save">Save</button></td></tr></tfoot></table></div>';
    ...
    add: function(a, b) {
      ...
      d = this.getNextFilterId();
      c = this.buildEntry(c, d);
      $.id("filter-list").appendChild(c);
      $.cls("fPattern", c)[0].focus()
    },
    remove: function(a) {
  ...
  IDColor = {
    ...
    compute: function(a) {
      ...
      b[1] = c >> 16 & 255;
      b[2] = c >> 8 & 255;
      b[3] = 125 < 0.299 * b[0] + 0.587 * b[1] + 0.114 * b[2];
      return this.ids[a] = b
    },
    apply: function(a) {
      var b;
  ...
  CustomCSS = {
    ...
    open: function() {
      var a;
      $.id("customCSSMenu") || (a = document.createElement("div"), a.id = "customCSSMenu", a.className = "UIPanel", a.setAttribute("data-cmd", "css-close"), a.innerHTML = '<div class="extPanel reply"><div class="panelHeader">Custom CSS<span><img alt="Close" title="Close" class="pointer" data-cmd="css-close" src="' + Main.icons.cross + '"></span></div><textarea id="customCSSBox">' + (localStorage.getItem("4chan-css") || "") + '</textarea><div class="center"><button data-cmd="css-save">Save CSS</button></div></td></tr></tfoot></table></div>', document.body.appendChild(a), a.addEventListener("click", this.onClick, !1), $.id("customCSSBox").focus())
    },
    save: function() {
      var a, b;
  ...
  Keybinds = {
    ...
    open: function() {
      var a;
      $.id("keybindsHelp") || (a = document.createElement("div"), a.id = "keybindsHelp", a.className = "UIPanel", a.setAttribute("data-cmd", "keybinds-close"), a.innerHTML = '<div class="extPanel reply"><div class="panelHeader">Keyboard Shortcuts<span><img data-cmd="keybinds-close" class="pointer" alt="Close" title="Close" src="' +
        Main.icons.cross + '"></span></div><ul><li><strong>Global</strong></li><li><kbd>A</kbd> &mdash; Toggle auto-updater</li><li><kbd>Q</kbd> &mdash; Open Quick Reply</li><li><kbd>R</kbd> &mdash; Update thread</li><li><kbd>W</kbd> &mdash; Watch/Unwatch thread</li><li><kbd>B</kbd> &mdash; Previous page</li><li><kbd>N</kbd> &mdash; Next page</li><li><kbd>I</kbd> &mdash; Return to index</li><li><kbd>C</kbd> &mdash; Open catalog</li><li><kbd>F</kbd> &mdash; Filter selected text</li></ul><ul><li><strong>Quick Reply (always enabled)</strong></li><li><kbd>Ctrl + Click</kbd> the post number &mdash; Quote without linking</li><li><kbd>Ctrl + S</kbd> &mdash; Spoiler tags</li><li><kbd>Esc</kbd> &mdash; Close the Quick Reply</li></ul>', document.body.appendChild(a), a.addEventListener("click", this.onClick, !1))
    },
    close: function() {
      var a;
  ...
  CustomMenu = {
    ...
    showEditor: function() {
      ...
      a.innerHTML = '<div class="extPanel reply"><div class="panelHeader">Custom Board List<span><img alt="Close" title="Close" class="pointer" data-close="1" src="' + Main.icons.cross + '"></a></span></div><input placeholder="Example: jp tg mu" id="customMenuBox" type="text" value="' + (Config.customMenuList || "") + '"><div class="center"><button data-save="1">Save</button></div></div>';
      document.body.appendChild(a);
...
var SettingsMenu = {
  ...
  Main = {
    ...
    init: function() {
      ...
      UA.init();
      Config.load();
      Main.firstRun && Config.loadFromURL() && (Main.firstRun = !1);
      (Main.stylesheet = Main.getCookie(style_group)) ? Main.stylesheet = Main.stylesheet.toLowerCase().replace(/ /g, "_") : Main.stylesheet = "nws_style" == style_group ? "yotsuba_new" : "yotsuba_b_new";
    ...
    isThreadClosed: function(a) {
      return (el = $.id("pi" + a)) && $.cls("closedIcon", el)[0]
    },
    setThreadState: function(a, b) {
      var c, d, e, f;
      f = a.charAt(0).toUpperCase() + a.slice(1);
      b ? (c = $.cls("postNum", $.id("pi" + Main.tid))[0], d = document.createElement("img"), d.className = a + "Icon retina", d.title = f, d.src = Main.icons2[a], "sticky" == a && (e = $.cls("closedIcon", c)[0]) ? (c.insertBefore(d, e), c.insertBefore(document.createTextNode(" "), e)) : (c.appendChild(document.createTextNode(" ")), c.appendChild(d))) : (d = $.cls(a + "Icon", $.id("pi" + Main.tid))[0], d.parentNode.removeChild(d.previousSibling), d.parentNode.removeChild(d));
      Main["thread" + f] = b
    },
    icons: {
      up: "arrow_up.png",
