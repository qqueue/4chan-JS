  ...
  Depager = {
    ...
    onScroll: function() {
      document.documentElement.scrollHeight <= window.innerHeight + window.pageYOffset +
        Depager.threshold && (Depager.threadsLoaded ? Depager.renderNext() : Depager.depage())
    },
